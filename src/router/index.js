...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'agreements', name: 'agreements', component: () => import('../pages/AgreementListPage.vue'), meta: { adminOnly: true } },
      { path: 'agreements/new', name: 'agreement-new', component: () => import('../pages/AgreementDetailPage.vue'), meta: { adminOnly: true } },
      { path: 'agreements/:id', name: 'agreement-detail', component: () => import('../pages/AgreementDetailPage.vue'), meta: { adminOnly: true } },
