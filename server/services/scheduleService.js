 ...
 */
export function listScheduled (filters = {}) {
 ...
 */
export function createScheduled (data, workerId) {
  const ts = now()
 ...
 * @param {number} id
 */
export function notePrefill (id) {
  const shift = getScheduled(id)
  return {
 ...
 * @param {number} workerId
 */
export function createNoteFromShift (id, noteData, workerId) {
  const shift = getScheduled(id)
 ...
 * @param {number} id
 */
export function restoreScheduled (id) {
 ...
 * @param {number} [days]
 */
export function upcomingScheduled (days = 14) {
