 ...
 * @returns {string[]}
 */
export function occurrenceDates (rec, from, to) {
 ...
 */
export function materialiseDueOccurrences (horizonDays = HORIZON_DAYS) {
 ...
 * rolling horizon stays populated. Safe to call once at boot.
 */
 ...
 */
export function createRecurrence (data, workerId) {
  const ts = now()
