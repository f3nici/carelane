 ...
 * @param {object} services assembled core services (for client display names)
 */
export function createAgreementService (ctx, services) {
   ...
   */
  function agreementDueDate (row, today, soon) {
   ...
   */
  function signAgreement (id, signedDate) {
   ...
   */
  function setAgreementPdf (id, filename) {
   ...
   * @param {number} id
   */
  function unarchiveAgreement (id) {
    getAgreement(id)
